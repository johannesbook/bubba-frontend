...
$lang['title_filemanager-browse']="Blättern";
...
$lang["DLNA streaming"]="DLNA Streaming";
...
$lang['backup-label-target-path'] = 'Zielordner';
$lang['backup-edit-dialog-step4-title'] = 'Backup Plan (Schritt 3 von 4)';
$lang['backup-label-schedule-disabled'] = 'Nicht geplant (Manuell starten durch Klick auf “Starten”)';
$lang['backup-create-dialog-step2-title'] = 'Wählen Sie aus, was gesichert werden soll (Schritt 2 von 5)';
$lang['backup-selection-music'] = 'Musik (/home/storage/music)';
$lang['weekday-3'] = 'Mittwoch';
$lang['backup-label-target-server-password'] = 'Kennwort des Zielservers';
$lang['backup-label-target-server-username'] = 'Benutzername des Zielservers';
$lang['Step 3/3: Network setup'] = 'Schritt 3 von 3: Netzwerk Setup';
$lang['backup-label-schedule-weekly-day'] = 'Wöchentlich';
$lang['backup-title-schedule-daily-hour'] = 'Tageszeit';
$lang['backup-selection-custom-browse'] = 'Blättern';
$lang['backup-selection-video'] = 'Videos (/home/storage/video)';
$lang['backup-edit-dialog-step5-title'] = 'Sicherheit (Schritt 4 von 4)';
$lang['backup-label-schedule-hourly'] = 'Stündlich';
$lang['users-system-default-lang'] = 'System Vorgabe';
$lang['backup-label-schedule-monthly-hour'] = 'um';
$lang['backup-edit-dialog-step3-title'] = 'Ziel der Datensicherung (Schritt 2 von 4)';
$lang['weekday-1'] = 'Montag';
$lang['backup-label-schedule-monthly-day'] = 'Monatlich am';
$lang['backup-create-dialog-step1-title'] = 'Wählen Sie einen Namen für die geplante Datensicherung (Schritt 1 von 5)';
$lang['backup-label-target-protocol'] = 'Protokoll';
$lang['backup-title-target-device'] = 'Ziel der Datensicherung';
$lang['backup-title-schedule-weekly-hour'] = 'Tageszeit';
$lang['backup-label-target-server-hostname'] = 'Ziel Server';
$lang['backup-label-security-enable'] = 'Verschlüsselung der Datensicherung um die Sicherheit zu erhöhen';
$lang['wizard-msg2'] = 'wizard-msg2';
$lang['backup-label-name'] = 'Name der Planung';
$lang['backup-selection-storage'] = 'Speicherung (/home/storage)';
$lang['backup-label-restore-newdir'] = 'Datenwiederherstellung in einem anderen Verzeichniss zur manuellen Untersuchung (in Bezug auf /home/admin)';
$lang['backup-edit-dialog-step2-title'] = 'Zu sichernde Daten (Schritt 1 von 4)';
$lang['backup-create-dialog-step5-title'] = 'Sicherheit (Schritt 5 von 5)';
$lang['backup-label-schedule-daily-hour'] = 'Täglich um';
$lang['backup-label-security-password2'] = 'Password wiederholen';
$lang['backup-create-dialog-step4-title'] = 'wahl der Backup Planung (Schritt 4 von 5)';
$lang['weekday-7'] = 'Sonntag';
$lang['backup-create-dialog-title'] = 'Neues Backup erstellen';
$lang['backup-title-schedule-weekly-day'] = 'Wochentag';
$lang['backup-selection-photo'] = 'Fotos (/home/storage/photos)';
$lang['backup-selection-email'] = 'E-Mail (/home/&lt;all users&gt;/Mail)';
$lang['backup-edit-dialog-title'] = 'Geplante Datensicherung ändern';
$lang['backup-title-schedule-monthly-day'] = 'Tag im Monat';
$lang['weekday-2'] = 'Dienstag';
$lang['Step 2/3: Create users'] = 'Schritt 2 von 3: Anwender erstellen';
$lang['title_backup'] = 'Datensicherung';
$lang['backup-job-add-button-label'] = 'Neue Datensicherung erstellen';
$lang['backup-create-dialog-step3-title'] = 'Wählen Sie das Ziel der Datensicherung (Schritt 3 von 5)';
$lang['backup-note-schedule-timeline'] = 'Je länger Sie die Zeitlinie wählen, desto mehr Speicherplatz wird auf dem Datenspeicher benötigt';
$lang['weekday-6'] = 'Samstag';
$lang['backup-label-target-device'] = 'Ziel';
$lang['backup-selection-data'] = 'Daten (/home/&lt;all users&gt;)';
$lang['backup-label-restore-missing'] = 'Wiederherstellen von Daten, die auf dem B3 nicht mehr verfügbar sind ohne existierende Daten zu überschreiben"';
$lang['backup-label-schedule-weekly-hour'] = 'um';
$lang['mail_server_userpwdmissing'] = 'Password des Mail Servers fehlt';
$lang['weekday-5'] = 'Freitag';
$lang['backup-title-schedule-monthly-hour'] = 'Tageszeit';
$lang['backup-label-security-password'] = 'Password';
$lang['Remote access through other router'] = 'Fernzugriff über andere Router';
$lang['Contact'] = 'Verbindung';
$lang['For more information'] = 'Für weitergehende Informationen';
$lang['a decade'] = 'eine Dekade';
$lang['User contributed languages'] = 'Nutzerspezifische Sprachen';
$lang['half a year'] = 'Halbjährlich';
$lang['a day'] = 'Täglich';
$lang['a year'] = 'Jährlich';
$lang['backup-title-protocol'] = 'Backup-Title-Protokoll';
$lang['Only A-Z,a-z,0-9 and \"-\" allowed'] = 'Nur A-Z,a-z,0-9 und \"-\" sind zugelassen';
$lang['a month'] = 'Monatlich';
$lang['a week'] = 'Wöchendlich';
$lang['Date'] = 'Datum';
$lang['Attached printers'] = 'Angeschlossene Drucker';
$lang['Manual'] = 'Handbuch';
$lang['Support'] = 'Support';
$lang['Schedule'] = 'Plan';
$lang['Default system language'] = 'Vorgegeben System Sprache';

$lang['backup-label-schedule-timeline'] = 'Ältere Datensicherungen eine Zeit lang behalten, aber wie folgt überschreiben';
$lang['backup-jobs-title'] = 'Übersicht der geplanten Datensicherungen';
$lang['backup-label-restore-overwrite'] = 'Revert the content of the files on the B3 to what is given in this backup';
$lang['backup-job-runs-title'] = 'Übersicht der ausgeführten Datensicherungen';
$lang['backup-title-schedule-timeline'] = 'Age of timeline';
$lang['backup-selection-custom'] = 'Individuelle Auswahl';
