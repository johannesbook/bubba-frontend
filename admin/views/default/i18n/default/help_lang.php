...
<p>From the File manager you are able to reach your files on Bubba eaven if you are away from home.</p>
<h3>Navigation</h3>
...
<h3>Photo album</h3>
<p>Logged in as administrator you are not able to add photos to the Bubba photo album. Log in with your standard user to add and manage photos and your albums.</p>
";
    ...
    <li>To run the job immediately, click 'Run now'.</li>
 	...
 	<p>As a security measure, perform a settings backup to save your backup jobs if you have to reinstall your Bubba. Click <Strong>Settings</Strong> in the menu and then <Strong>Backup settings</Strong></p>
  ";
...
$lang['help_box_users']="
	<h3>Users</h3>
	<p>Here you find all the registered users on your Bubba. Click on 'Edit user' to change user information.</p>
...
$lang['help_box_mail']=$lang['help_box_mail_index']="
	<h3>Email</h3>
	<p>Bubba will fetch your email from all your different external email accounts you may have. The email will be stored on Bubba and available via IMAP or webmail, wherever you are.</p>
	<p>Active email accounts will be shown here.</p>
	<h3>Set up Bubba for retrieving email</h3>
	...
	<p>You must select to which user the retrieved email should be directed, this must be done for every added email account. Prior to this you must have added a Bubba user.</p>
	
";
	
$lang['help_box_mail_server_settings']="
	<h3>Email server</h3>
  <p>Leave fields empty to let Bubba handle your outgoing emails. If your ISP blocks your outgoing traffic on port 25 you must use an alternative SMTP server than Bubba, fill in the information provided to you by your ISP.</p>
	<h3>Email domain</h3>
	<p>If you have your own domain name Bubba will handle your incoming and outgoing email.</p>
...
$lang['help_box_network']=$lang['help_box_network_profile']=$lang['help_box_update_profile']="
  ...
  <p>Automatic settings will work in most cases, you do probably not need to change this. Read the technical manual if you need further information.</p>
	...
	<p><strong>Router + Firewall + Server</strong> - Bubba will automatically try to retrieve network settings on WAN (internet), and use fixed network settings on the local network providing other computers with network information.</p>
...
$lang['help_box_network_wlan']="
	...
	<h3>Wireless</h3>
  <p><strong>Wireless access point</strong> - Switch to enable the wireless access point in Bubba.</p>
  ...
  <p><strong>Broadcast SSID </strong>- Show or hide Bubbas SSID for wireless devices. By default the SSID is broadcasted.</p>
  <p><i>Update</i> saves your changes.</p>
";
...
$lang['help_box_network_fw']="
  ...
  <p><strong>Email server (Port 25)</strong> - Enables access from WWW to Bubba's port 25. This is the default email server port for sending and receiving email.</p>
...
$lang['help_box_disk_lvm']="
	...
	<h3>Warning</h3>
	<p><strong>Please notice that this is a non reversible operation. After your system has been extended together with the external drive, your system will always need to be connected to the external drive - and will not function without it. To be able to use your Bubba standalone again, you will need to reinstall the whole system.</strong></p>
...
$lang['help_box_disk_raid']="
  ...
  <p><strong>List of RAID disks</strong> - shows the disks attached to the RAID system.</p>
	...
	<ol>
    <li>Disconnect the broken external disk from the backside of Bubba.</li>
    ...
    <li>Press 'Close' to continue working with Bubba. The synchronization is in progress and will take a while.</li>
  </ol>
  
  <h3>Recover an internal disk</h3>
	<p>If you have a disk failure on your internal disk in Bubba you have to start by exchanging the disk and reinstalling via an USB memory. Then update Bubba to the latest software.</p>
	<ol>
...
<h3>Setup wizard</h3>
<p>Use the integrated Setup wizard to make the very first important settings on your Bubba such as time and date, add users and choose an Easyfind name. You can run the wizard at any time.</p>
...
<p><strong>Use 'Easyfind' to locate your Bubba</strong> - Using our free service Easyfind you will be able to reach your Bubba wherever you are. You will be able to find your Bubba wherever you are typing www.-your easyfind name-.bubbaserver.com.</p>
...
<p>'Backup settings' will backup all your Bubba settings, nice to have in case you reinstall Bubba or move the settings to another Bubba unit. The following settings will be saved :</p>
<ul>
...
<p>Bubba's software can easily be updated to gain new functionality. Press 'Update system', and the update is automatically performed. Please have patient, it might take a while to perform an update.</p>
...
<p>By default this feature is enabled. Use the switch to disable Hotfixes. If doing so you might not get the most important updates to your Bubba. </p>
...
<p>Detailed information about Bubba software versions is shown here.</p>
...
<h3>Photo album</h3>
<p>To view your photos in Bubbas photo album you have to place the photos in the home/storage/pictures catalog. </p>
<p>Then select the files or folders and use the <strong>Add to album</strong> icon in the file function bar to add your photos to the Bubba photo album. </p>
<p>Continue to the Album manager (via Bubbas start page) to publish the photos.</p>
";
...
<ol>
  ...
  <ul>
  	...
  	<li>Or click 'Public' if you want the album to be open to anyone who can access your Bubba, then click Update.</li>
  </ul>
  <li>Done!</li>
</ol>
...
<p>Your photo albums will be visible by browsing to <a href='http://bubba/album' target='_blank'>http://bubba/album</a> (<a href='http://bubba.local/album' target='_blank'>http://bubba.local/album</a> if using Mac) from inside your home network, or by browsing to www.-your easyfind name-.bubbaserver.com from outside your network.</p>
";
...
<ul>
  <li>Public album can be seen by anyone, you do not have to add any album users. </li>
	...
	<li>Remember that the Bubba users and photo album viewers are not the same.</li>
<ol>
