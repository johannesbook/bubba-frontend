...
<p>Welcome to Bubba|2!</p>
<p>Listen to music, look at your photos, and access your emails and files. You have all your most important information and fun within a simple mouse click away!</p>
<p></p>
";
...
$lang['help_box_network_lan']="
	<p>Here you configure how you reach your Bubba|2 from computers in your Local Area Network (LAN). Your Bubba|2 has an auto detect function on the LAN port. This means that when connected, Bubba|2 will search the LAN for a DHCP server. If a DHCP server is found, Bubba|2 will configure itself to obtain an IP address on  the LAN port. If no DHCP server is found, Bubba|2 will fall back to the static IP address <strong>192.168.10.1</strong>. </p>
